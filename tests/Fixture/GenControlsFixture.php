 ...
 * GenControlsFixture
 */
class GenControlsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'regulatory_body_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-05-31 09:04:12',
                'modified' => '2019-05-31 09:04:12'
            ],
        ];
        parent::init();
    }
