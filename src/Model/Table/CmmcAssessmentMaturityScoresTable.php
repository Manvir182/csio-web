 ...
 */
class CmmcAssessmentMaturityScoresTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('cmmc_assessment_maturity_scores');
        $this->setDisplayField('id');
        $this->setPrimaryKey('id');

        $this->belongsTo('CmmcAssessmentLevels', [
            'foreignKey' => 'cmmc_assessment_level_id'
        ]);
    }
    ...
    {
        $rules->add($rules->existsIn(['cmmc_assessment_level_id'], 'CmmcAssessmentLevels'));
