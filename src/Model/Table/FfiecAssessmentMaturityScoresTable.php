 ...
 */
class FfiecAssessmentMaturityScoresTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('ffiec_assessment_maturity_scores');
        $this->setDisplayField('id');
        $this->setPrimaryKey('id');

        $this->belongsTo('FfiecAssessmentDomains', [
            'foreignKey' => 'ffiec_assessment_domain_id'
        ]);
    }
    ...
    {
        $rules->add($rules->existsIn(['ffiec_domain_id'], 'FfiecAssessmentDomains'));
