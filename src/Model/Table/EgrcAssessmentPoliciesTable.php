 ...
 */
class EgrcAssessmentPoliciesTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('egrc_assessment_policies');
        ...
        $this->hasMany('EgrcAssessmentPolicyStatements', [
            'foreignKey' => 'egrc_assessment_policy_id',
            'dependent' => true,
        ]);
        $this->hasMany('EgrcAssessmentMaturityScores', [
            'foreignKey' => 'egrc_assessment_policy_id',
            'dependent' => true,
        ]);
