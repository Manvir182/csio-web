...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $assessmentsRegulatoryBody->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $assessmentsRegulatoryBody->id)]
            )
        ?></li>
...
<div class="assessmentsRegulatoryBodies form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Assessments Regulatory Body') ?></legend>
        <?php
