	      		...
	      		<div class="col-12">
					<div class="loginoptions">
	      			<?php
						...
						echo $this->Html->link('<span class="float-left"><i class="fa fa-briefcase"></i></span> Analysts',
							'/analysts/login'
						,[
							'class'=>'loginlinkbox m-0','escape'=>false
						]);
						...
						echo $this->Html->link('<span class="float-left"><i class="fa fa-briefcase"></i></span>Admin',
							'/superadmin'
						,[
							'class'=>'loginlinkbox btn btn-danger btn-block','escape'=>false
						]);
						*/
		        	?>
					</div>
