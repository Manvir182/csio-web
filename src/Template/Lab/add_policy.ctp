					...
					<div class="row">
						<div class="col-10 offset-1">
							<div class="card">
								...
								<div class="card-body">
									<?php echo $this -> Form -> create('Policy',['class'=>'policyForm', 'type'=>'file','url'=>$this->Url->build(array('controller'=>'lab','action'=>'savePolicy'),true)]); ?>
									<?php
									...
									<div class="row">
										...
										<div class="col-3">
											<small class="text-secondary">
												<i>
													Eg. Information Security <?php echo $dtype; ?> |  Encryption <?php echo $dtype; ?> 
												</i>
											</small>
										</div>
									</div>
