<div class="row page-titles">
    <div class="col-md-8 col-8">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Employees Listing</li>
        </ol>
    </div> 
		    ...
		    <table cellpadding="0" cellspacing="0" class="table table-bordered table-stripped">
		        <thead>
		            <tr>
		                ...
		                <th scope="col">Department (Size)</th>
		        ...
		        <tbody>
		            ...
		            <tr>
		                ...
		                <td class="actions">
		                    ...
		                    <?= $this->Form->postLink("<i class='fa fa-times'></i>", ['action' => 'delete', $user->id], ['class'=>'btn btn-xs btn-danger text-white','escape'=>false,'data-toggle'=>'tooltip','title'=>'Delete Employee', 'confirm' => __('Are you sure you want to delete # {0}?', $user->id)]) ?>
		                </td>
		            </tr>
		            <?php endforeach; ?>
		        </tbody>
