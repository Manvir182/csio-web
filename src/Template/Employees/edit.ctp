    ...
    <div class="col-md-4 col-4 text-right">
    	<div class="btn-group btn-sm">
    		<?php
				...
				echo $this->Html->link('<i class="fa fa-plut"></i> Create New',array(
        ...
        <div class="card-block">
        	...
        	?>
        		<div class="row ">
					...
					<div class="col-md-12">
						<br>
                        <h4 class="cisoredc">Employee Profile</h4>
                    </div>
					<?php
						echo $this->Form->control('position_title',array(
							'class'=>'form-control',
							'required'=>true,

							'label'=>array('class'=>'cl-font-13','text'=>'Position Title')
						));
			            echo $this->Form->control('email',array(
							'class'=>'form-control',
							'required'=>true,

							'label'=>array('class'=>'cl-font-13','text'=>'Email Address')
						));

			             echo $this->Form->control('department_id',array(
							'class'=>'form-control',
							'required'=>true,

							'label'=>array('class'=>'cl-font-13','text'=>'Department')
						));

			            echo $this->Form->control('department_size',array(
							'class'=>'form-control',
							'required'=>true,
							'label'=>array('class'=>'cl-font-13','text'=>'Department Size')
						));
	                ...
	                echo $this->Form->control('phone',array(
						...
						'value'=>$employee['contcode'].$employee['phone'],
                      ));
	                ...
	                echo $this->Form->control('contcode',array(
                          	'type'=>'text',
							'id' =>'contcode',
							'value' => $employee['contcode'],
							'class' => 'hide',
						));
					echo '</span>';
					?>
		    		<div class="col-md-12 m-t-20">
		    			<?= $this->Form->button(__('Update Now'),array('class'=>'btn btn-success')) ?>
		    		</div>
		    		</div>
		    		<?= $this->Form->end() ?>
        </div>
