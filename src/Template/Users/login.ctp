...
<head>
   ...
   <?= $this->Html->charset() ?>
    ...
    <title>
        Super Admin Login | THE CLOUD CISO
    </title>
    <?= $this->Html->meta('icon') ?>
                ...
                <div class="login_form cisoblue-outline  cisoblue cisoblue-border row">
					...
					<?php
                		echo $this->Html->link('Forgot Password?',array(
							...
							'class'=>'forgotlink text-center tag-line',
							'style'=>"font-size:16px;text-transform:uppercase;font-weight:normal;color:#233149;"
						]);
                	?>
                	<?php echo $this->Form->end(); ?>
                </div>
                <p class="backtohome" style="padding-top:10px;">
