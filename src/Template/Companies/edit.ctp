...
<div class="row page-titles">
    <div class="col-md-8 col-8 align-self-center">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Modify Company</li>
        </ol>
    </div>
        		...
        		<div class="row ">
					...
					<?php
						echo $this->Form->control('username',array(
							...
							'label'=>array('class'=>'cl-font-13','text'=>'User Name')
						));
			            echo $this->Form->control('password',array(
							'class'=>'form-control',
							//'required'=>true,

							'label'=>array('class'=>'cl-font-13','text'=>'Password')
						));
					?>
					<div class="col-md-12">
						<br>
					...
					<?php
						...
						echo $this->Form->control('industry',array(
							...
							'label'=>array('class'=>'cl-font-13','text'=>'Industry')
						));
						echo $this->Form->control('email',array(
			             ...
			             echo $this->Form->control('phone',array(
							'class'=>'form-control',
							'required'=>true,
							'value'=>$company['contcode'].$company['phone'],
							'id'=>'phone',
							'label'=>array('class'=>'cl-font-13','text'=>'Company Phone')
						));

			             echo $this->Form->control('extension',array(
							'class'=>'form-control',

							'label'=>array('class'=>'cl-font-13','text'=>'Extension')
						));
			             echo $this->Form->control('company_size',array(
							'class'=>'form-control',
							'required'=>true,

							'label'=>array('class'=>'cl-font-13','text'=>'Company Size')
						));
                	...
                	<?php
                		...
                		echo $this->Form->control('subscribed',array(
							...
							'label'=>array('class'=>'cl-font-13','text'=>' Do you wish to subscribe to further updates news regarding our services?'),
							'type'=>'checkbox',
							'checked'=>$company->subscribed=='Yes'?true:false
						));
                	?>
		    		...
		    		<div class="col-md-12 m-t-20">
		    			<?= $this->Form->button(__('Submit'),array('class'=>'btn btn-warning')) ?>
		    		</div>
		    		</div>
		    		<?= $this->Form->end() ?>
        </div>
