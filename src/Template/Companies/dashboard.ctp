		...
		<div class="table-responsive">
					...
					<?php else: ?>
						<table class="table table-bordered">
							<thead>
								<tr style="background-color:#233149;">
									<th>Activity</th>
									<th>Regulation</th>
							...
							<tbody>
								<?php foreach($reguComplianceData as $reguCompliance): ?>
									<tr>
										<th class="text-dark"><?php echo $reguCompliance['activity']; ?></th>
										<td>
...
<center style="font-size:25px;line-height:40px;font-family:arial;">
	...
	<span class="btn btn-sm btn-info badge-pill">
		...
		<span class="badge badge-inverse badge-pill" style="font-size:inherit;">
...
<section class="maap-section">
	...
	<h4 class="title text-center map-title">Risk &amp; Maturity Level Capability Progress</h4>
		...
		<div class="tab-content bg-white p-10" id="myTabContent" style="border-width:1px;border-style:solid;border-color:#fff #dee2e6 #dee2e6;">
...
<?php if(!empty($dashData['assessment'])): ?>
<hr class="bg-info">
<?php if($dashData['assessment']->sub_type=='Regulated'): ?>
	...
	<div class="accordion" id="rbAccordion">
		...
		<?php $i=0;
		foreach($dashData['assessment']->assessments_regulatory_bodies as $rBody):
	...
	$(function(){
		var lineChartData2 = {
		    ...
		    datasets: [ {
		    	borderColor:"#111111",
		    	//pointRadius: '5',
		    	pointBackgroundColor:'#333333',//'#009efb',
