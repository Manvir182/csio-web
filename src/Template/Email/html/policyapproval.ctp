...
<div style="width:80%;margin:10px auto;padding:25px;background:#ffffff;border-radius:8px; box-shadow:0 0 4px #222;">
	...
	<h2 align="center">
		&mdash; Policy/Standard Approval Request. &mdash;
	</h2>
	...
	<p>
		New Policy/Standard "<?php echo $policy_name; ?>(<?php echo $document_number; ?>)" is added or updated on THE CLOUD CISO
		and submitted for your approval.
	</p>
	<p>
		<b>Login to your portal to review and approve:</b><br>
		<?php
			echo $this->Html->link('Approver\'s Portal ',array(
				'_name'=>'approver-login','_full' => true
			));
		?>
	</p>
	<p>
	...
	<p style="background:#e6e7e7; text-align:center;padding:20px;">
		&copy; Copyrights THE CLOUD CISO <?php echo date('Y'); ?>
	</p>
</div>