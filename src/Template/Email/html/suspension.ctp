...
<div style="width:80%;margin:10px auto;padding:25px;background:#ffffff;border-radius:8px; box-shadow:0 0 4px #222;">
	...
	<h2 align="center">
		&mdash; Account Suspended &mdash;
	</h2>
	<p style="text-align:center;color:#777777;">
		Dear <?php echo $first_name; ?>,
		<br>
		<br>
		Your company account with THE CLOUD CISO is suspended on <?php echo date('d-M-Y h:i a',strtotime($reg_status_date)); ?>.<br>
		<br>
		<b>Remarks for Suspension:</b>
		<br>
		<?php echo $reg_status_remarks; ?>
		<br>
		<br>
		<i>
			Please contact us at info@thecloudciso.com if you have questions regarding this decision.
		</i>
