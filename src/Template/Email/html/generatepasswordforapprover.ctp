...
<div style="width:80%;margin:10px auto;padding:25px;background:#ffffff;border-radius:8px; box-shadow:0 0 4px #222;">
	...
	<h2 align="center">
		&mdash; Generate New Password Request. &mdash;
	</h2>
	<p style="text-align:center;color:#777777;">
		We have received the request to generate password. We at CISO are really concerned about security.
	...
	<p>
		...
		<?php
			echo $this->Html->link('Click here to reset password',array(
				'controller'=>'approvers','action'=>'resetPassword',$password_reset_token,'_full' => true
			));
		?>
	</p>
	<p>
