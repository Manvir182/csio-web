	...
	<body style="font-family:Arial, Helvetica, sans-serif;">
		<div id="report" class="report" style="">
			...
			<ul style="list-style:none;">
				...
				<li>
					...
					<ul style="list-style:none;">
						<?php $sr=0; foreach($assessment->assessment_risks as $maRisk): ?>
							<li>3.<?php echo $sr+=1; ?> <?php echo $maRisk->risk; ?></li>
						<?php endforeach; ?>
					</ul>
				</li>
				<li>
					...
					<ul style="list-style:none;">
						<?php $sr=1; foreach($assessment->assessment_controls as $maControl): ?>
			...
			<p>
				...
				<?php
					$noOfReqs = 0;
					foreach($assessment->assessment_controls as $ac){
				...
				<?php
					...
					foreach($assessment->assessment_risks as $ar){
				...
				<table style="" cellspacing="0" cellpadding="5" border="1" bordercolor="#222222" width="100%">
					...
					<tbody>
						<?php foreach($assessment->assessment_risks as $ar): ?>
			...
			<p>
				<?php
					$noOfNonCompliance=0;
					foreach($assessment->assessment_controls as $acs){
			...
			<table style="" cellspacing="0" cellpadding="5" border="1" bordercolor="#222222" width="100%">
				...
				<tbody>
					<?php foreach($assessment->assessment_controls as $acs): ?>
		...
		<h3>1.2 <u>Table of Findings</u></h3>
				...
				<table width="100%" border="1" bordercolor="#333" cellspacing="0" style="font-size:10px;">
					<thead>
						<tr>
							...
							<th style="text-align:center;" colspan="<?php echo count($assessment->assessment_controls); ?>"  class="text-dark">Control Areas</th>
						</tr>
						<tr>
							...
							<?php foreach($assessment->assessment_controls as $eCont): ?>
			...
			<p align="justify">
				...
				policies and procedures. A total of <?php echo count($assessment->assessment_risks); ?> risk areas
				were assessed and mapped to <?php echo count($assessment->assessment_controls); ?>, in addition
			...
			<p align="justify">
				The Analysis considered logical controls in <?php echo count($assessment->assessment_risks); ?>
				Risk Domains for the <?php echo $company->company_name; ?> environment.
			</p>

			<?php $sr=0; foreach($assessment->assessment_risks as $aRisk): ?>
			...
			<p align="justify">
				The Analysis considered controls in <?php echo count($assessment->assessment_controls); ?>
			...
			<p align="justify">
				...
				<?php echo count($assessment->assessment_controls); ?> broad, yet discreet, Control Domains.
			...
			<?php $sr=1; foreach($assessment->assessment_controls as $aControl): ?>
