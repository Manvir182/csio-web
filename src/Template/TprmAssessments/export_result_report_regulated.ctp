...
<html>
	<head>
		...
		<?php if($assessment->status=='Review or Draft'): ?>
			<style>
				...
				h4:before {
					content:'DRAFT',
					position:absolute;top:4in;left:3in;font-size:1in;font-weight:bold;color:rgba(2,2,2,0.1);transform:rotate(-45deg);
				}
	...
	<body style="background-image:url(<?php echo $this->request->getAttribute('webroot').'img/draft.png'; ?>);">
		...
		<div id="report" class="report">
			...
			<ul style="list-style:none;">
				<li>
					...
					<ul style="list-style:none;">
						<li>
							1.1 Conclusions
							<ul style="list-style:none;">
								<lh>Regulatory Bodies:</lh>
								<?php $sr=0; foreach($assessment->assessments_regulatory_bodies as $aBody): ?>
									<li>1.1.<?php echo $sr+=1; ?> <?php echo $aBody->regulatory_body->name; ?></li>
								<?php endforeach; ?>
							</ul>
						</li>
						<li>
							...
							<ul style="list-style:none;">
								<lh>Regulatory Bodies:</lh>
								<?php $sr=0; foreach($assessment->assessments_regulatory_bodies as $aBody): ?>
									<li>1.2.<?php echo $sr+=1; ?> <?php echo $aBody->regulatory_body->name; ?></li>
								<?php endforeach; ?>
							</ul>
						</li>
					</ul>
					...
					<ul style="list-style:none;">
						<li>
							...
							<ul style="list-style:none;">
								<lh>Regulatory Bodies:</lh>
								<?php $sr=0; foreach($assessment->assessments_regulatory_bodies as $aBody): ?>
									<li>2.1.<?php echo $sr+=1; ?> <?php echo $aBody->regulatory_body->name; ?></li>
								<?php endforeach; ?>
							</ul>
						</li>
						<li>
				...
				<li>
					...
					<ul style="list-style:none;">
						<lh>Regulatory Bodies:</lh>
						<?php $sr=1; foreach($assessment->assessments_regulatory_bodies as $aBody): ?>
							<li>
								3.<?php echo $sr+=1; ?> <?php echo $aBody->regulatory_body->name; ?>
								<ul style="list-style:none;">
									<?php $srr=0; foreach($aBody->assessment_risks as $maRisk): ?>
									<li>3.<?php echo $sr; ?>.<?php echo $srr+=1; ?> <?php echo $maRisk->risk; ?></li>
								<?php endforeach; ?>
								</ul>
							</li>
						<?php endforeach; ?>
				...
				<li>
					...
					<ul style="list-style:none;">
						...
						<?php $sr=1; foreach($assessment->assessments_regulatory_bodies as $aBody): ?>
							<li>
								4.<?php echo $sr+=1; ?> <?php echo $aBody->regulatory_body->name; ?>
								<ul style="list-style:none;">
									<?php $sra=1; foreach($aBody->assessment_controls as $maControl): ?>
										<li>4.<?php echo $sr.".".$sra+=1; ?> <?php echo $maControl->name; ?></li>
									<?php endforeach; ?>
								</ul>
							</li>
						<?php endforeach; ?>
				...
				<li>
					...
					<ul style="list-style:none;">
						<li>
							5.1 Mapping of Risk Families to Control Domains
							<ul style="list-style:none;">
								<lh>Regulatory Bodies:</lh>
								<?php $a=0;  foreach($rcmappings as $rcmap): ?>
									<li>5.1.<?php echo $a+=1; ?> <?= $rcmap->name ?></li>
								<?php endforeach; ?>
							</ul>
						</li>
					</ul>
			...
			<p>
				...
				<?php
					...
					$expTable=$rcmap['exceptions']['expTable'];
					$excepHeaders=$rcmap['exceptions']['excepHeaders'];
					$expRisks=$rcmap['exceptions']['expRisks'];


				?>
				<h5>1.2.<?php echo $a+=1; ?> Regulatory Body: <?= $rcmap->name ?></h5>
				<p>
					...
					<table width="100%" border="1" bordercolor="#333" cellspacing="0" style="font-size:10px;">
						<thead>
							<tr>
								...
								<th style="text-align:center;" colspan="<?php echo count($rcmap['exceptions']['aConts']); ?>"  class="text-dark">Control Areas</th>
							</tr>
							<tr>
								...
								<?php foreach($rcmap['exceptions']['aConts'] as $eCont): ?>
			...
			<?php $sr=1; foreach($assessment->assessments_regulatory_bodies as $aBody): ?>
				<h4>3.<?php echo $sr+=1; ?> Regulatory Body: <?php echo $aBody->regulatory_body->name; ?></h4>
				<p align="justify">
				...
				<?php $sra=0; foreach($aBody->assessment_risks as $aRisk): ?>
					...
					<h5>3.<?php echo $sr.".".$sra+=1; ?> <?php echo $aRisk->risk; ?></h5>
					<h5>Overview</h5>
					<p align="justify">
			...
			<?php $sr=1; foreach($assessment->assessments_regulatory_bodies as $aBody): ?>
				<h4>4.<?php echo $sr+=1; ?> Regulatory Body: <?php echo $aBody->regulatory_body->name; ?></h4>
				<p align="justify">
			...
			<?php $a=0;  foreach($rcmappings as $rcmap): ?>
				...
				<table cellspacing="0" cellpadding="2" style="font-size:15px;border:1px solid;border-width:0px 0px 1px 1px;">
				  	<thead>
				  		<tr>
				  		...
				  		<?php $i=1; foreach($table as $risk_id=>$rows): ?>
					  		<tr>
					  			...
					  			<?php $j=0; foreach($rows as $row): ?>
					  				<td style="<?php echo $row['mapping']==""?'background:#ffffcc;':''; ?>border:1px solid #333;border-width:1px 1px 0 0;text-align:center;">
		...
		<script>
		    ...
		    function exportHTML(){
		       var header = "<html xmlns:o='urn:schemas-microsoft-com:office:office' "+
		            ...
		            "<head><meta charset='utf-8'><title>Assessment Report</title></head><body>";
