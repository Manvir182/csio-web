 ...
 */
class GenControlsController extends AppController
{
	...
	public function initialize(){
		parent::initialize();
		$this->set('pageHeading','Generalized Assessment Control Areas');
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
			...
			$rControl = array(
				...
				'guidance'=>$data['RbControls']['guidance']
			);
	...
	public function rcmappings(){
		...
		$rcMapping = $this->GenRcMappings->find('all',[
			'contain'=>['Risks','GenControls']
		])->all();
